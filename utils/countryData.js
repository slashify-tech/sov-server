const allCountry = [
    ...
    "Costa Rica", "Cote D'Ivoire (Ivory Coast)", "Croatia", "Cuba", "Curaçao",
    ...
    "Greenland", "Grenada", "Guadeloupe", "Guam", "Guatemala", "Guernsey and Alderney",
    ...
    "Lithuania", "Luxembourg", "Macau S.A.R.", "Madagascar", "Malawi", "Malaysia",
    ...
    "Peru", "Philippines", "Pitcairn Island", "Poland", "Portugal", "Puerto Rico",
    "Qatar", "Reunion", "Romania", "Russia", "Rwanda", "Saint Helena", "Saint Kitts and Nevis",
    "Saint Lucia", "Saint Pierre and Miquelon", "Saint Vincent and the Grenadines",
    "Saint-Barthelemy", "Saint-Martin (French part)", "Samoa", "San Marino",
    ...
    "The Bahamas", "Timor-Leste", "Togo", "Tokelau", "Tonga", "Trinidad and Tobago",
  ...
  const preferredCountry = [
    ...
    "Spain",  "Finland", "Poland", "Slovenia", "Georgia"
  ];
  
  export { preferredCountry, allCountry };
